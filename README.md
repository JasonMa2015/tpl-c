...
为了提高前后端人员开发前端效率以及规范前端开发流程，特配置了一套前端开发模板。该模板是一套基于vue2.5.2、vue-router3.0.1、vuex3.0.1、iview3.1.0、axios0.18.0、vux2.9.2、vux主题定制以及jquery3.3.1的开发模板，同时配置了babel-polyfill解决了IE兼容性问题，以及eslint4.15规范以及跨域代理。
